...
def loadDatadet(infile):
    ...
    return dataset
def cross_validation(intMat, seeds, cv=0,n_fold=10):
...
if __name__ == '__main__':
    ...
    resultpath = "./result/"+dataset+'/'+dataset+"_CWM-DTI_S2.txt"
    ...
    for seed in seeds:
        ...
        for i in range(0, n_fold):
            ...
            history = my_model.fit(train_feature_resampled, train_label_resampled, epochs=Epoch,
                                   batch_size=Batchsize, verbose=True, callbacks=[earlystop], validation_data=(test_feature_resampled, test_label_resampled))
